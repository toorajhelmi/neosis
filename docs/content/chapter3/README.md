...
### {CH}.2.2 Local State and Required Inputs
...
### {CH}.2.3 Node-Level In-Life Learning Rule
...
### {CH}.2.4 Stochasticity and Lex's Role
...
## {CH}.3 Relationship Between Learnability and Survival
